...
<section
	class="pb-16 pt-32"
	style="background-color: {project.heroColor || '#000000'}; color: {project.heroColor
		? '#FFFFFF'
		: '#000000'}"
>
	<Container>
			...
			<div in:fly={{ y: 20, duration: 600, delay: 100 }}>
				<Button
					...
					style="color: {project.heroColor
						? '#FFFFFF'
						: '#000000'}; border-color: {project.heroColor ? '#FFFFFF' : '#000000'}"
				>
					← Retour au portfolio
				</Button>
			</div>
			...
			<div in:fly={{ y: 20, duration: 600, delay: 200 }}>
				<div class="mb-6 flex flex-wrap items-center gap-4">
					<Typography
						variant="overline"
						className="font-mono"
						style="color: {project.heroColor ? '#FFD700' : '#FFD700'}"
					>
						{project.category}
					</Typography>
				...
				<Typography variant="h1" className="mb-4 font-display" style="color: inherit">
					{project.title}
				</Typography>
...
<section class="mb-16">
	<Container size="xl">
		<div
			class="aspect-video overflow-hidden border-2 border-noir bg-gris-clair"
	...
	<Container>
		<div class="mx-auto max-w-4xl space-y-16">
			...
			<div in:fly={{ y: 20, duration: 600, delay: 400 }}>
				<Typography variant="h2" className="mb-6 font-display">Le Défi</Typography>
			...
			<div in:fly={{ y: 20, duration: 600, delay: 500 }}>
				<Typography variant="h2" className="mb-6 font-display">Notre Solution</Typography>
			...
			{#if project.results}
				<div in:fly={{ y: 20, duration: 600, delay: 600 }}>
					<Typography variant="h2" className="mb-8 font-display">Résultats</Typography>
					<Grid cols={2} gap="md">
			...
			{#if project.awards}
				<div in:fly={{ y: 20, duration: 600, delay: 700 }}>
					<Typography variant="h2" className="mb-8 font-display">Reconnaissance</Typography>
			...
			{#if project.deliverables}
				<div in:fly={{ y: 20, duration: 600, delay: 700 }}>
					<Typography variant="h2" className="mb-8 font-display">Livrables</Typography>
					<div class="space-y-3">
			...
			{#if project.note}
				<div
					...
					class="border-2 border-noir bg-gris-clair p-8"
				>
